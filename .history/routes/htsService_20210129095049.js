...
//2: Use frist user's private key to sign the transaction and then second user should received the 
//H21: Adding text like info to Fungible as well as NFT tokens
//Use transaction memo for adding the fileId
//Implement this and show what kind of information we can add, share and see transperently in Kabuto
//Give reference to the Kabuto for above transactions.
//KYC Integration:
