...
router.route('/associate').post(async (req, res) => {
    try {
        ...
        const client = hederaClientLocal(req.body.token_id], process.env.TREASURY_PRIVATE_KEY);
        ...
        // tx.addTokenTransfer(process.env.TOKEN_ID, process.env.TREASURY_ACCOUNT_ID, -1);
        // tx.addTokenTransfer(process.env.TOKEN_ID, req.body.id, 1);
