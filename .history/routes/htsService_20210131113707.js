...
router.route('/create-nfToken').post(async (req, res) => {
    ...
    try {
        ...
        if (fileId !== "") {
            ...
            const token = {
                name: tokenName,
                symbol: fileId !== "" ? "msg://" + fileId : undefined ,
                decimals: 0,
                initialSupply: 1,
                adminKey: undefined,
                ...
                message: fileId !== "" ? "hedera://" + fileId : undefined ,
            };
...
router.route('/transfer').post(async (req, res) => {
    try {
        ...
        let hBars = 0;
        const tx = await new TransferTransaction();
        tx.addTokenTransfer(req.body.rid, req.body.sid, -req.body.amount);
        tx.addTokenTransfer(req.body.rid, req.body.rid, req.body.amount);
        ...
        const signTx = await tx.sign(PrivateKey.fromString(req.body.sPK));
